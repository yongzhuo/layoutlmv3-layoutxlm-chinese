...
from transformers import BertForSequenceClassification as LayoutLMv2ForSequenceClassification
from transformers import BertTokenizer as LayoutXLMTokenizerFast
